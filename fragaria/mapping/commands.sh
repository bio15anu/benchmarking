...
do ls ${BENCHPATH}/fragaria/reads/${file}/100000_1/ | cut -d "." -f1 | sort -n | while read chunk;
do echo "${RAZERS3_DIR}/razers3 -rr 100 -i 95 -tc 1 -dr 0 -m 5 -ll 750 -le 750 -ds \
-o ${BENCHPATH}/fragaria/mapping/${file}/razers3/${chunk}.bam \
${BENCHPATH}/fragaria/genome/fragaria.fa \
${BENCHPATH}/fragaria/reads/${file}/100000_1/${chunk}.fastq.gz \
${BENCHPATH}/fragaria/reads/${file}/100000_2/${chunk}.fastq.gz";
...
do cd ${BENCHPATH}/fragaria/mapping/${rep}/bismark; ${BENCHPATH}/bin/runBismark.sh \
${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_1.fastq ${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_2.fastq \
fragaria; cd ${BENCHPATH}/fragaria/mapping; done
...
ls | grep x$ | while read rep;
do cd ${BENCHPATH}/fragaria/mapping/${rep}/bsseeker2; ${BENCHPATH}/bin/runBSSeeker2.sh \
${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_1.fastq ${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_2.fastq \
fragaria; cd ${BENCHPATH}/fragaria/mapping; done
deactivate
...
ls | grep x$ | while read rep;
do cd ${BENCHPATH}/fragaria/mapping/${rep}/bwameth; ${BENCHPATH}/bin/runBWAmeth.sh \
${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_1.fastq ${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_2.fastq \
fragaria; cd ${BENCHPATH}/fragaria/mapping; done
unset PYTHONPATH
...
ls | grep x$ | while read rep;
do cd ${BENCHPATH}/fragaria/mapping/${rep}/erne-bs5; ${BENCHPATH}/bin/runERNE.sh \
${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_1.fastq ${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_2.fastq \
fragaria; cd ${BENCHPATH}/fragaria/mapping; done
...
ls | grep x$ | while read rep;
do cd ${BENCHPATH}/fragaria/mapping/${rep}/gem-mapper; ${BENCHPATH}/bin/runGEM3.sh \
${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_1.fastq ${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_2.fastq \
fragaria; cd ${BENCHPATH}/fragaria/mapping; done
...
ls | grep x$ | while read rep;
do cd ${BENCHPATH}/fragaria/mapping/${rep}/gsnap; ${BENCHPATH}/bin/runGSNAP.sh \
${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_1.fastq ${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_2.fastq \
fragaria; cd ${BENCHPATH}/fragaria/mapping; done
...
ls | grep x$ | while read rep;
do cd ${BENCHPATH}/fragaria/mapping/${rep}/last; ${BENCHPATH}/bin/runLast.sh \
${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_1.fastq ${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_2.fastq \
fragaria; cd ${BENCHPATH}/fragaria/mapping; done
...
ls | grep x$ | while read rep;
do cd ${BENCHPATH}/fragaria/mapping/${rep}/segemehl; ${BENCHPATH}/bin/runSegemehl.sh \
${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_1.fastq ${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_2.fastq \
fragaria; cd ${BENCHPATH}/fragaria/mapping; done
...
ls | grep x$ | while read rep;
do cd ${BENCHPATH}/fragaria/mapping/${rep}/bsmap; ${BENCHPATH}/bin/runBSmap.sh \
${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_1.fastq ${BENCHPATH}/fragaria/reads/${rep}/bisulfite/simulated_2.fastq \
fragaria; cd ${BENCHPATH}/fragaria/mapping; done
...
# merge GSNAP files
ls ${BENCHPATH}/fragaria/mapping | grep x$ | while read rep; \
...
# convert maf to sam
ls ${BENCHPATH}/fragaria/mapping/*/last/*.maf | while read maf;
do sam=$(echo $maf | sed 's/\.maf$/\.sam/'); python2 ${LASTMAP_DIR}/maf-convert sam -d $maf > $sam; \
echo "finished with: ${maf}"; rm $maf; done

# convert sam to bam
ls ${BENCHPATH}/fragaria/mapping/*/{bsmap,bwameth,gem-mapper,last,segemehl}/*.sam | while read sam; \
